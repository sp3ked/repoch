...
export async function scrapeStartupData(searchQuery: string): Promise<void> {
    ...
    try {
        await page.goto(`https://www.google.com/search?q=${encodeURIComponent(searchQuery + " startup")}`);
...
function extractKeywords(text: string): string[] {
    ...
    const startupKeywords = [
        'innovation', 'technology', 'startup', 'entrepreneur', 'funding',
        'venture capital', 'growth', 'disrupt', 'scale', 'agile',
        'AI', 'blockchain', 'SaaS', 'IoT', 'fintech', 'biotech',
